...
public class Peticion {
	...
	public String toString() {
		return "Peticion : peticionesTotales = "+this.getPeticionesTotales()+" ; peticionesConcurrentes = "+this.getPeticionesConcurrentes()+
				" ; peticionesPorSegundo = "+this.getPeticionesPorSegundo()+" ; servicio = "+this.getServicio()+" ; deployment = "+this.getDeployment()+
				" ; hpa = "+this.getHpa() + "; namespace = "+this.getNamespace();
	}
}
